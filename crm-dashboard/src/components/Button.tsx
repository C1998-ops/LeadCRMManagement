...
const Button: React.FC<ButtonProps> = ({
	...
	const VARIANTS = {
		primary: 'bg-secondary-gold text-white hover:bg-secondary-gold/90 active:bg-secondary-gold/80',
		secondary: 'bg-primary-navy text-white hover:bg-primary-navy/90 active:bg-primary-navy/80',
		tertiary:
		...
		outlineSecondary:
			'border-2 border-primary-navy text-primary-navy bg-transparent hover:bg-transparent active:bg-transparent',
		outlinePurple:
			'border-2 border-secondary-purple text-secondary-purple bg-transparent hover:bg-transparent active:bg-transparent',
		...
		textNavy:
			'text-primary-navy hover:text-primary-navy/90 active:text-primary-navy/80 underline bg-transparent hover:bg-transparent',
		textWhite:
			'text-white hover:text-white/90 active:text-white/80 underline bg-transparent hover:bg-transparent border-0 focus:border-0 focus:outline-none focus:ring-0 focus:shadow-none',
		textPurple:
			'text-secondary-purple hover:text-secondary-purple/90 active:text-secondary-purple/80 underline bg-transparent hover:bg-transparent border-0 focus:border-0 focus:outline-none focus:ring-0 focus:shadow-none',
	};
