...
const statusStyles: Record<LeadStatus, string> = {
  ...
  "Site Visit":
    "bg-secondary-yellow-100 text-primary-orange border-secondary-yellow-200/30",
  Negotiation:
    "bg-secondary-red-100 text-secondary-red-300 border-secondary-red-200",
};
...
function Dashboard() {
  ...
  const columns: TableColumn<LeadRow>[] = [
    ...
    },
    {
      key: "owner",
      header: "Owner",
      className: "min-w-[110px] text-neutral-dark",
    },
    {
      key: "lastActivity",
        ...
        <div className="flex gap-4 items-start min-w-0">
          ...
          >
            <DataTable
              ...
              totalCount={(leads ?? seedLeads).length}
              onRowClick={(row) => {
